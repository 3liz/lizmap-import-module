        ...
        if ($group) {
            ...
            if (!empty($group)) {
                ...
                try {
                    ...
                    jLog::log('An error occurred while grant access on the schema to the given group: ' . $group, 'error');

                    throw new jException('import~db.query.grant.bad');
                }
            }
        }
    }
